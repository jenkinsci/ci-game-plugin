...
public class ViolationsRuleSet extends PluginRuleSet {
	...
	protected void loadRules() {
        ...
        add(new DefaultViolationRule("checkstyle", "Checkstyle violation", -5, 5));
        add(new DefaultViolationRule("findbugs", "FindBugs violation", -5, 5));
        add(new DefaultViolationRule("fxcop", "FXCop violation", -5, 5));
	}
}
